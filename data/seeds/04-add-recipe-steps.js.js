    ...
    .then(function() {
      return knex("recipe_step").insert([
        ...
        },
        {
          ...
          stepNumber: 2,
          step:
            "Heat a large saute pan over medium heat. Melt butter in the hot pan, making sure not to let it burn. Give eggs 1 last mix and pour into the pan. Reduce heat to low and cook, stirring frequently and slowly, about 10 minutes"
        },
        {
          recipe_id: 2,
          stepNumber: 3,
        ...
        },
        {
          recipe_id: 3,
          stepNumber: 1,
          step: "Break egg into pan of light oil"
        },
        {
          recipe_id: 3,
          stepNumber: 2,
          step: "Add chicken franks and half sliced tomatoes on the pan "
        },
        {
          recipe_id: 3,
          stepNumber: 3,
          step: "season with black pepper and pinch of salt"
        },
        {
          recipe_id: 3,
          stepNumber: 4,
          step: "turn egg sides as well as the franks and tomatoes."
        }
      ]);
    });
};
